...
- The durable worker currently covers auto-review, planned draft generation, chapter summaries, and Manuscript Blueprint generation; the other long AI routes still run in request-bound handlers.
