...
- Auto-review job start now supports queue-first handoff and true resume via existing job ids.
...
- Auto-review wizard regression coverage now validates launch-token reuse across handshake and worker-launch requests.
- Auto-review wizard regression coverage now validates launch-token reuse in both fresh-start and resume success paths.
...
- Software-factory execution artifacts: phased execution log and engineering TODO.
