/**
 * /settings/geek-analytics — the engineering-telemetry view formerly at
 * /analytics. Moved here once /analytics was rebuilt as a simplified,
 * user-facing page (cost, model performance, time-on-book, results) --
 * this is where all of that original detail lives now, for anyone who
 * wants it (same spirit as YouTube's "Stats for Nerds").
 *
...
export default async function GeekAnalyticsPage() {
  ...
  return (
    <Container size="xl">
      <Stack gap="xl">
        <DataFreshnessBanner routeKey="geek-analytics:runs" fetchedAt={new Date().toISOString()} label="Analytics data" variant="subtle" />
        <div>
          <Group gap="xs" align="baseline">
            <Title>Geek Analytics</Title>
            <Badge color="dark" variant="light">for the curious</Badge>
          </Group>
          <Text c="dimmed">
            The full engineering telemetry behind every workflow — Auto-Review Wizard runs below, manual
            Critic/Blueprint/Rewrite runs, job-health stats, and raw model-call volume further down. Click any
            Auto-Review row to see per-stage timing and score progression. Looking for the simple view? See{" "}
